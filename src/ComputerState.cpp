...
void GameLayer::enterComputerState(ComputerState state) {
    ...
    exit_button = Components::createButton(
        registry, [this] {
            setState(GameState::G_GAME);
            return true;
        }, glm::vec2{675.0f, 130.0f}, glm::vec2{150.0f, 70.0f},
        typewriter::ResourceManager::loadSprite("assets/Buttons.png", typewriter::RectI{24, 0, 12, 5})
    );
    ...
    switch (current_computer_state) {
        ...
        case ComputerState::G_MENU: {
            food_button = Components::createButton(
                registry, [this] {
                    setComputerState(ComputerState::G_FOOD);
                    return true;
                }, glm::vec2{100.0f, 170.0f}, glm::vec2{90.0f, 90.0f},
                typewriter::ResourceManager::loadSprite("assets/Buttons.png", typewriter::RectI{0, 0, 8, 8})
            );

            game_button = Components::createButton(
                registry, [this] {
                    setComputerState(ComputerState::G_GAME);
                    return true;
                }, glm::vec2{205.0f, 170.0f}, glm::vec2{90.0f, 90.0f},
                typewriter::ResourceManager::loadSprite("assets/Buttons.png", typewriter::RectI{16, 0, 8, 8})
            );

            news_button = Components::createButton(
                registry, [this] {
                    setComputerState(ComputerState::G_NEWS);
                    return true;
                }, glm::vec2{310.0f, 170.0f}, glm::vec2{90.0f, 90.0f},
                typewriter::ResourceManager::loadSprite("assets/Buttons.png", typewriter::RectI{8, 0, 8, 8})
            );

            break;
        }
        case ComputerState::G_FOOD: {
            food_order_button = Components::createButton(
                registry, [this] {
                    ...
                    return true;
                }, glm::vec2{400.0f, 325.0f}, glm::vec2{190.0f, 100.0f},
                typewriter::ResourceManager::loadSprite("assets/Buttons.png", typewriter::RectI{0, 8, 22, 7})
            );

            return_button = Components::createButton(
                registry, [this] {
                    setComputerState(ComputerState::G_MENU);
                    return true;
                }, glm::vec2{570.0f, 130.0f}, glm::vec2{70.0f, 70.0f},
                typewriter::ResourceManager::loadSprite("assets/Buttons.png", typewriter::RectI{24, 5, 5, 5})
            );
            break;
        }
    ...
    switch (current_computer_state) {
        ...
        case ComputerState::G_GAME: {
            ...
            if (game_boot_timer > GAME_BOOT_TIME) {
                ...
                if (obstacle_spawn_timer > OBSTACLE_SPAWN_TIME) {
                    ...
                    typewriter::AABB obstacle{
                        glm::vec2{OBSTACLE_SPAWN_POSITION_X, OBSTACLE_SPAWN_POSITION_Y},
                        glm::vec2{OBSTACLE_SPAWN_WIDTH, OBSTACLE_SPAWN_HEIGHT}
                    };
        ...
        case ComputerState::G_NEWS: {
            ...
            for (int i = starting_point; i < starting_point + MESSAGE_MAX_SHOWN; ++i) {
                ...
                // Read button
                Button button{
                    glm::vec2{MESSAGE_POSITION_X + MESSAGE_WIDTH, MESSAGE_POSITION_Y + offset_y,},
                    glm::vec2{MESSAGE_READ_WIDTH, MESSAGE_READ_HEIGHT}
                };
...
void GameLayer::renderComputerState(ComputerState state) {
    switch (current_computer_state) {
        ...
        case ComputerState::G_GAME: {
            if (game_boot_timer > GAME_BOOT_TIME) {
                // Draw ground
                typewriter::Renderer2D::drawSprite(
                    typewriter::ResourceManager::loadSprite("assets/Game.png", typewriter::RectI{0, 0, 16, 8}), 100.0f,
                    400.0f, 650.0f, 65.0f);

                // Draw player
                typewriter::Renderer2D::drawSprite(
                    typewriter::ResourceManager::loadSprite("assets/Game.png", typewriter::RectI{0, 8, 6, 8}), 115.0f,
                    320.0f + player_y_pos, 40.0f, 70.0f);

                // Draw obstacles
                for (const auto &obstacle: obstacles) {
                    typewriter::Renderer2D::drawSprite(
                        typewriter::ResourceManager::loadSprite("assets/Game.png", typewriter::RectI{16, 0, 16, 16}),
                        obstacle.min.x, obstacle.min.y, obstacle.max.x - obstacle.min.x,
                        obstacle.max.y - obstacle.min.y);
                }
            } else {
                typewriter::Renderer2D::drawSprite(
                    typewriter::ResourceManager::loadSprite("assets/UI.png", typewriter::RectI{0, 0, 16, 16}), 400.0f,
        ...
        case ComputerState::G_NEWS: {
            ...
            if (reading_message == std::nullopt) {
                ...
                for (int i = starting_point; i < starting_point + MESSAGE_MAX_SHOWN; ++i) {
                    ...
                    typewriter::Sprite sprite = typewriter::ResourceManager::loadSprite(
                        "assets/Buttons.png", typewriter::RectI{36, 0, 32, 9});
                    typewriter::Renderer2D::drawSprite(sprite, MESSAGE_POSITION_X, MESSAGE_POSITION_Y + offset_y,
                    ...
                    // Read button
                    typewriter::Sprite read_button_sprite_green = typewriter::ResourceManager::loadSprite(
                        "assets/Buttons.png", typewriter::RectI{36, 9, 15, 6});
                    typewriter::Sprite read_button_sprite_red = typewriter::ResourceManager::loadSprite(
                        "assets/Buttons.png", typewriter::RectI{51, 9, 15, 6});
                    if (!msg.read)
                        typewriter::Renderer2D::drawSprite(read_button_sprite_green, MESSAGE_POSITION_X + MESSAGE_WIDTH,
                                                           MESSAGE_POSITION_Y + offset_y, MESSAGE_READ_WIDTH,
                                                           MESSAGE_READ_HEIGHT);
                    else
                        typewriter::Renderer2D::drawSprite(read_button_sprite_red, MESSAGE_POSITION_X + MESSAGE_WIDTH,
                                                           MESSAGE_POSITION_Y + offset_y, MESSAGE_READ_WIDTH,
                                                           MESSAGE_READ_HEIGHT);
                    auto read_button_text = typewriter::ResourceManager::loadText(font, "READ");
                    typewriter::Renderer2D::drawText(read_button_text.get(), MESSAGE_POSITION_X + MESSAGE_WIDTH,
                                                     MESSAGE_POSITION_Y + offset_y);
                ...
                typewriter::Renderer2D::drawRectangle(MESSAGE_POSITION_X - 20.0f, MESSAGE_POSITION_Y - 20.0f, 300.0f,
                                                      300.0f, typewriter::Color::DarkSlateGrey);
            }
        }
        break;
        default:
